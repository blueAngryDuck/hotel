...
if(empty($imie) || empty($nazwisko) || empty($mail) || empty($adres) || empty($telefon) || empty($dataod) || empty($datado)){
 header ("location: rezerwacja8.php");
}
else {
...
$zap2=" INSERT INTO rezerwacja (id_pokoju, rezerwacja_od, rezerwacja_do, id_pracownika, id_klienta) VALUES ('8', '$dataod', '$datado', '2', '$lastidklienta')";
        ...
        <div class="row g-0">
          ...
          <div class="col-md-8">
            <div class="card-body">
              ...
              <p class="card-text">Zarezerwowales pokoj</p>
