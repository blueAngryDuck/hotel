<?php
    ...
    if(empty($imie) || empty($nazwisko) || empty($email) || empty($telefon)) {
      ...
      $query = "SELECT * FROM rekrutacja WHERE imie='$imie' AND nazwisko='$nazwisko' AND email='$email' AND telefon='$telefon'";
      $result = mysqli_query($id, $query);
    }
      
      if(mysqli_num_rows($result)==0){
        $q = "INSERT INTO rekrutacja (imie, nazwisko, stanowisko, telefon, email) VALUES ('$imie', '$nazwisko', '$stanowisko', '$telefon', '$email')";
        $rez = mysqli_query($id, $q);
        // $lastid = mysqli_insert_id($id);
    }
    //   else {
    ...
    // }
        ...
        echo "<h4>Nie ma polaczenia</h4>";
    }

    // if(isset($_POST['submit'])) {
    //     $stanowisko = $_POST['stanowisko'];
    //     if(!empty($stanowisko)) {
    //         $query = "INSERT INTO rekrutacja (stanowisko) VALUES('$stanowisko');";
    //     }
    //     else {
    //         echo "<h4>Wybierz stanowisko</h4>";
    //     }
    // }
        ...
        <div class="row align-items-center block">
            <div class="col-md-6 ">
               <div class="text-algin-center">
                <h3>Hotel KKZ.INF-03 we Wrocławiu zatrudnia pracownikow!</h3>
                <p>Szukasz pracy?<br>Potrzebujemy takich jak ty!<br><br>Wypelnij fornularz i my zadwonimy do ciebie.</p>
                <p>Adres: Fabryczna 13, 53-609 Wrocław<br>Lokalizacja: Wrocławski Park Przemysłowy</p>
                <hr>
            ...
            <div class="col-md-6 ">
                <?php
                   echo "<h5>$imie  $nazwisko , dziekujemy, ze wyslales wniosek!";
                ?>
            </div>
    </main>
            ...
            <div class="row mt-4">
              ...
              <div class="col-lg-4 col-md-6 mb-4 mb-md-0">
                ...
                <ul class="list-unstyled">
                  <li>
                    <a href="./rekrutacja.php" class="text-white">Pracuj z nami</a>
                  </li>
                  <li>
