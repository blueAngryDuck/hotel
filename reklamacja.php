<?php
if(!isset($_POST['imie'])){
  echo "blad polączenia z serwerem";
  exit();
}
  $id=mysqli_connect("localhost", "root", "", "hotel");
  if(!$id){
    echo "blad polączenia z BD";
    exit();
  }
...
if(empty($imie) || empty($nazwisko) || empty($mail) || empty($telefon) || empty($opis)){
  header ("location: kontakty.html");
 }
else {
$query = "SELECT * FROM klienci WHERE imię='$imie' AND nazwisko='$nazwisko' AND e_mail='$mail' AND telefon='$telefon'";
$result = mysqli_query($id, $query);
}

if(mysqli_num_rows($result)==0){
  $zap = "INSERT INTO klienci (imię, nazwisko, e_mail, telefon, adres) VALUES ('$imie', '$nazwisko', '$mail', '$telefon', '0')";
  $wynikzap = mysqli_query($id, $zap);
  $lastidklienta = mysqli_insert_id($id);
  $zap1="INSERT INTO reklamacji ( id_pracownika, opis, id_klienta, status_reklamacji) VALUES ('0', '$opis', '$lastidklienta', '0')";
  ...
  $zap2="INSERT INTO reklamacji ( id_pracownika, opis, id_klienta, status_reklamacji) VALUES ('0', '$opis', '$imiedb', '0')";
  $wynikzap2 = mysqli_query($id, $zap2);
}


// }
// if($imiedb=$$imie && $nazwiskodb=$nazwisko){
...
//   }
// }
//$query1="INSERT INTO reklamacji (opis, id_klienta, status_reklamacji) VALUES ('nie mogę zarezerwowac pokój', '7', '0');";
                ...
                <div class="container-fluid">
                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                      ...
                      <li class="nav-item">
                        <a class="nav-link active text-uppercase" aria-current="page" href="#">O nas</a>
                      </li>
                      <li class="nav-item">
        ...
        <div class="row align-items-center block">
            <div class="col-md-6 ">
               <div class="text-algin-center">
                <h3>Hotel KKZ.INF-03 we Wrocławiu</h3>
                <p>Adres: Fabryczna 13, 53-609 Wrocław</p>
                <p>Lokalizacja: Wrocławski Park Przemysłowy</p>
                <hr>
                <p>Telefon: 71 355 56 72</p>
                <p>E-mail: technikum-wroclaw@teb-edukacja.pl</p>
            ...
            <div class="col-md-6 ">
                   <?php
                    ...
                    echo "<h5>$imie  $nazwisko wyslales zapytanie o tresci: </h5><br><p><em> $opis</em></p>";
                  ?>
            </div>
    </main>
