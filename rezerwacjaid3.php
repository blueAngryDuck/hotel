...
if(empty($imie) || empty($nazwisko) || empty($mail) || empty($adres) || empty($telefon) || empty($dataod) || empty($datado)){
 header ("location: rezerwacja3.php");
}
else {
...
$zap2=" INSERT INTO rezerwacja (id_pokoju, rezerwacja_od, rezerwacja_do, id_pracownika, id_klienta) VALUES ('3', '$dataod', '$datado', '2', '$lastidklienta')";
