        ...
        <div class="row g-0">
          ...
          <div class="col-md-8">
            <div class="card-body">
              ...
              <p class="card-text">Podaj swoje dane osobowe, e-mail,telefon, adres oraz datę rezerwacji.v</p>
              <form action="rezerwacjaid3.php" method="post" class="row g-3 needs-validation" novalidate  >
                <div class="col-md-4">
