...
if(empty($imie) || empty($nazwisko) || empty($mail) || empty($adres) || empty($telefon) || empty($dataod) || empty($datado)){
 header ("location: rezerwacja7.php");
}
else {
...
$zap2=" INSERT INTO rezerwacja (id_pokoju, rezerwacja_od, rezerwacja_do, id_pracownika, id_klienta) VALUES ('7', '$dataod', '$datado', '2', '$lastidklienta')";
